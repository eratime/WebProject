      ...
      <div class="main">  <!--内容-->
         ...
         <div class="right"> <!--右边框-->
            <div class="news_title"> <!--标题栏-->
                <h2><span>您当前位置：<a href="index.php">首页>></a><a href="#"><?php echo $classname;?></a></span><a href="#"><?php echo $classname;?></a></h2>
            </div><!--标题栏-->
            <div class="news_content"><!--新闻内容-->
               ...
               <?php
				if($classname=="全部新闻"){
					$sql=mysql_query("select * from zu2_newslist order by id desc");
				}else{
            		$sql=mysql_query("select * from zu2_newslist where classname='".$classname."' order by id desc");
				}
				while($array=mysql_fetch_row($sql)){
					echo '<li><span>'.$array[7].'</span><a href="show.php">'.cutstr($array[2],45,15).'</a></li>';
				}
			?>
